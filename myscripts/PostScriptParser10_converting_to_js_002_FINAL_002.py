...
def write_postscript_functions(newPath, functionName, writefile):
    ...
    writefile.write("var point = new Point(0, 0);\n")
    ...
    if len(pathNames) > 1:
        ...
        writefile.write(lineToPrint)
        writefile.write("compoundPath.fillColor = 'black';\n")
        writefile.write("compoundPath.strokeColor = 'black';\n")
    else:
        writefile.write("path0.fillColor = 'black';\n")
