...
def regex_plotListString(plotListString):
    ...
    |   [-0-9.]+\s[J]   # value J = set line cap
    |   [-0-9.]+\s[j]   # value j = set line join
    |   [-0-9.]+\s[M]   # value M = set miter limit
                        # value value m = move to
                        # value value l = line to
                        # [optional value] value d =
                        # q value value value value cm =
                        # value*6 c = curve to
                        # S = set stroke
                        # Q = seems to be a delimter.
                        # h = closePath();
